  ...
  $.fn.lazyload = function (options) {
    return this.each(function () {
      ...
      var imgerr = function (e, target, fn, src) {
        if (target[0].src && (target[0].src.indexOf("img-err.png") >
            0 || target[0].src.indexOf("img-err2.png") > 0)) {
          return;
        }
        var w = target.width();
        var h = target.height();
      ...
      var tempImg = function (target) {
          ...
          var tempDom = target.clone().addClass("lazy-loding").insertBefore(
            target);
      ...
      var scrollHandle = function () {
        ...
        $.each(opts.cache, function (i, data) {
          ...
          if (o) {
            ...
            if ((post >= 0 && post < contHeight) || (posb > 0 &&
                posb <= contHeight)) {
              if (url) {
                //在浏览器窗口内
                if (tag === "img") {
